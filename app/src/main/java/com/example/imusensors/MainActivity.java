...
//        Uri currentDataUri = Uri.fromFile(dataFile);
//        DownloadManager.Request request = new DownloadManager.Request(currentDataUri);
//
...
//        manager.enqueue(request);
        ...
        createExtFile(Uri.fromFile(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)));
    ...
    private File createDataFile() throws IOException {
        ...
        dataFileName = "IMUData_" + timeStamp; // file name
    ...
    private void createExtFile(Uri pickerInitialUri) {
        ...
        if (requestCode == CREATE_FILE) {
            if (resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    outputStream.write(readTextFromUri(Uri.fromFile(dataFile))
                            .getBytes(StandardCharsets.UTF_8));
                    outputStream.close();
